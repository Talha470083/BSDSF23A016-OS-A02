...
static int cmpstr(const void *a, const void *b) {
    ...
    return strcmp(sa, sb);  // Alphabetical (lexicographic) order
}
...
int main(int argc, char *argv[]) {
    ...
    // ----------------------------------------------------
    // Read all filenames into a dynamic array
    // ----------------------------------------------------
    ...
    while ((ent = readdir(dir)) != NULL) {
        ...
        // Duplicate filename and store it
    ...
    // ----------------------------------------------------
    // Display: Down then Across (horizontal column mode)
    // ----------------------------------------------------
